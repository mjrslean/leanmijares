...
<template>
  <div class="flex flex-col gap-6 tracking-wide md:flex-row">
    ...
    <div class="flex flex-col space-y-10">
      ...
      <div class="text-sm-base space-y-8 tracking-wide">
        ...
        <a
          as="button"
          href="https://drive.google.com/file/d/1sH6VvdBCanjBhUAQ5fAQMOAJwPqk2W5G/view?usp=sharing"
          class="bg-golden-yellow rounded-lg px-4 py-3"
        >
          <label class="cursor-pointer font-bold">Download my CV</label>
        </a>
      </div>
    </div>
  </div>
